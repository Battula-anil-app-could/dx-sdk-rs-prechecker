...
impl<M: ManagedTypeApi> EllipticCurve<M> {
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `scalar_mult` instead.")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `marshal` instead.")]
    #[cfg(feature = "alloc")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `unmarshal` instead.")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `generate_key` instead.")]
    #[cfg(feature = "alloc")]
