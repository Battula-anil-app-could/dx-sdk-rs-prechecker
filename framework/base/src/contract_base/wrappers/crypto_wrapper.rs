    ...
    A: CryptoApi,
{
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `sha256` instead.")]
    #[cfg(feature = "alloc")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `keccak256` instead.")]
    #[cfg(feature = "alloc")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `ripemd160` instead.")]
    #[cfg(feature = "alloc")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `verify_bls` instead.")]
    ...
    #[deprecated(since = "0.0.8", note = "Please use method `verify_ed25519` instead.")]
